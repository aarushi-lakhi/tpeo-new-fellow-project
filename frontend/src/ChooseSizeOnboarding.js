...
import GenderSizes from './components/GenderSizes.js';
...
export default function ChooseSizeOnboarding() {
    return (
        <Box sx={wrap}>
            <NavBar/>
            <Box sx={secondContainer}>
                <Box sx={blueBox}>
                    ...
                    <Box sx={genderSizeWrap}>
                        <GenderSizes text="Female Sizes"/>
                        <GenderSizes text="Male Sizes"/>
                        <GenderSizes text="Unisex Sizes"/>
                    </Box>
