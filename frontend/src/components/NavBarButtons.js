...
const NavBarButtons = ({ isProfilePage }) => {
    ...
    return (
        <Stack flex="1" direction="row" justifyContent="space-evenly" alignItems="center">
            <Box p={2} sx={{ backgroundColor: isProfilePage ? "#D9D9D9": "#A5B9E0" , display: "flex", justifyContent: "center", alignItems: "center", '&:hover': { backgroundColor: isProfilePage ? "#A5B9E0": "#D9D9D9"  } }}>
